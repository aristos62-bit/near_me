...
7. Ποτε δε κανεις compact το chat αν δεν ενημερώσεις πρωτα oldseesions.md τι ακριβως κάνουμε γα να μπορείς να επανέλθεις μετα στο ίδιο σημείο
8. ΟΛΑ τα back upd γίνονται save στον φάκελο backups του project
9. Αν δε θυμάσαι αυτούς τους κανόνες, σταμάτα και ρώτα
