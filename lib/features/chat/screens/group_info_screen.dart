...
class _GroupInfoScreenState extends ConsumerState<GroupInfoScreen> {
  ...
  void _onDocChanged(DocumentSnapshot? snap) {
    ...
    if (name != _groupName ||
        !const MapEquality().equals(roles, _participantRoles) ||
        maxP != _maxParticipants) {
      DebugConfig.log(DebugConfig.uiInteraction,
          'GroupInfoScreen._onDocChanged: name=$name maxP=$maxP rolesChanged=${!const MapEquality().equals(roles, _participantRoles)}');
      setState(() {
        _groupName = name;
