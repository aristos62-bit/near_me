...
class _SearchParams {
  ...
  bool operator ==(Object other) =>
      other is _SearchParams && other.query == query && other.city == city && listEquals(other.tags, tags);
      ...
      body: Column(children: [
        Padding(
          padding: EdgeInsets.only(
            left: ResponsiveUtils.paddingValueFromWidth(ResponsiveUtils.resolveWidth(context, null)),
            right: ResponsiveUtils.paddingValueFromWidth(ResponsiveUtils.resolveWidth(context, null)),
            top: 8,
          ),
          child: TextField(
          ...
          children: [
            Row(children: [
              CircleAvatar(
                ...
                child: Text(group.groupName.isNotEmpty
              ...
              if (isCreator)
                Chip(
                  label: Text(greek ? 'Δικός σου' : 'Yours',
